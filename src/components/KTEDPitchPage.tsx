...
interface KTEDPitchPageProps {
  onBack: () => void;
}

export default function KTEDPitchPage({ onBack }: KTEDPitchPageProps) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-gray-50">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          <motion.button
            ...
            onClick={onBack}
            className="flex items-center gap-2 text-primary-200 hover:text-white transition-colors duration-300 group"
          >
      ...
      <footer className="bg-gray-900 text-gray-400 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 pt-6 grid grid-cols-1 md:grid-cols-3 gap-4 text-center md:text-left text-sm items-center">
            <div>
